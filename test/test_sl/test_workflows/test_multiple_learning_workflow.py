...
class TestMultipleLearningWorkflow(unittest.TestCase):
    ...
    def test_set_terminated_all_terminated(self):
        mlw = mls.sl.workflows.MultipleLearningWorkflow(config_directory=self.cd)
    ...
    def test_task_expand_config_all_should_have_expanded(self):
        mlw = mls.sl.workflows.MultipleLearningWorkflow('full_multiple_config.json', config_directory=self.cd)
        mlw.task_expand_config()
    ...
    def test_task_expand_config_fairness_should_have_expanded(self):
        ...
        """
        mlw = mls.sl.workflows.MultipleLearningWorkflow('multiple_config_multiple_fairness.json',

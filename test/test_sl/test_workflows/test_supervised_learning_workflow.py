...
class TestSupervisedLearningWorkflow(unittest.TestCase):
    ...
    def test_run_all_step_should_be_executed(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(bd, 'PrepareDataTask', 'data.json')))
        self.assertTrue(os.path.isfile(os.path.join(bd, 'PrepareDataTask', 'data-content.h5')))
        self.assertTrue(os.path.isfile(os.path.join(bd, 'PrepareDataTask', 'data.json')))
        self.assertTrue(os.path.isfile(os.path.join(bd, 'PrepareDataTask', 'data-content.h5')))
        self.assertTrue(os.path.isfile(os.path.join(bd, 'SplitDataTask', 'split_data.json')))
        self.assertTrue(os.path.isfile(os.path.join(bd, 'SplitDataTask', 'train-content.h5')))
        self.assertTrue(os.path.isfile(os.path.join(bd, 'SplitDataTask', 'test-content.h5')))
        self.assertTrue(os.path.isfile(os.path.join(bd, 'SplitDataTask', 'raw_train-content.h5')))
        self.assertTrue(os.path.isfile(os.path.join(bd, 'SplitDataTask', 'raw_test-content.h5')))
        self.assertTrue(os.path.isfile(os.path.join(bd, 'EvaluateTask', 'evaluation.json')))

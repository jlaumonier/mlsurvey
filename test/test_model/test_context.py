...
class TestContext(unittest.TestCase):
    ...
    def test_init_all_init(self):
        ...
        self.assertIsInstance(context.raw_data, mls.models.Data)
    ...
    def test_save_context(self):
        ...
        self.assertEqual('30600de9ab15e04bc25b3d4d75db2b01', mls.Utils.md5_file(log.directory + 'input.json'))
    ...
    def test_load_context(self):
        ...
        self.assertEqual(0, len(context.raw_data.y_pred))
        self.assertIsInstance(context.data, mls.models.Data)

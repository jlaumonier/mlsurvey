...
class FairnessWorkflow(LearningWorkflow):
    ...
    def __init__(self, config_file='config_fairness.json', config_directory='config/', base_directory='', context=None):
        ...
        self.context = mls.sl.models.Context(eval_type=mls.sl.models.EvaluationFairness)
    ...
    def task_get_data(self):
        ...
        try:
            if not self.is_sub_process:
                ...
                self.context.dataset = mls.sl.datasets.DataSetFactory.create_dataset(dataset_type)
                ...
                self.context.data = mls.sl.models.DataFactory.create_data(dataset_storage,
